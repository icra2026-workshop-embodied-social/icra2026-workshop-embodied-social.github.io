...
function convertSingleTime(timeString, targetTimeZone) {
    ...
    const localOffset = getTimezoneOffset(Intl.DateTimeFormat().resolvedOptions().timeZone);
    ...
    const targetTime = new Date(timeString).toLocaleString("en-US", {
        timeZone: Intl.DateTimeFormat().resolvedOptions().timeZone
    });

    print("converted target time: ", targetTime);
